      ...
      <div className="bg-dark-subtle">
         <header className="bg-dark-subtle">
            ...
            <Navbar bg="dark" variant="dark">
               <Container>
                  <Navbar.Brand href="#home">Apotek Khalifah Kush</Navbar.Brand>
                  <Nav className="me-auto">
                     <Nav.Link href="#features">Transaksi</Nav.Link>
                  </Nav>
                  +,Nav+
               </Container>
            </Navbar>
            ...
            <div className='container-md p-8 m-10'>
               <h1 className='text-left my-4'>Stok Obat</h1>
               <Table striped bordered hover size="sm" className='fs-6'  variant="dark">
                  <thead>
                     <tr>
                        <th>Kode</th>
                        <th>Nama Obat</th>
